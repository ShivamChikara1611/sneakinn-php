...
<head>
    ...
    <title>Sneakinn - checkout page</title>
...
<body>
    ...
    <div class="banner">
        ...
        <div class="detail">
            <h1>checkout</h1>
            <p>Complete your purchase now. Choose your size, add to cart, and proceed to checkout. Secure payment options available. Step into style effortlessly.</p>
            <span><a href="index.php">home</a><i class="fa-solid fa-greater-than"></i>checkout</span>
        </div>
    </div>
