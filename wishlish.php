...
<head>
    ...
    <title>Sneakinn - My Wishlist page</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>My Wishlist</h1>
            <p>Step into comfort and style with our latest collection! From sleek sneakers to durable boots, find your perfect pair and step up your footwear game today.</p>
            <span><a href="index.php">home</a><i class="fa-solid fa-greater-than"></i>My Wishlist</span>
        </div>
    </div>
