...
<head>
    ...
    <title>Sneakinn - Admin Add Products page</title>
            ...
            <div class="form-container">
                <form action="" method="post" enctype="multipart/form-data" class="register">
                    ...
                    <div class="input-field">
                        ...
                        <input type="number" name="stock" maxlength="100" min="0" max="999999999" placeholder="add product stock" required class="box">
                    </div>
                    ...
                    <div class="flex-btn">
                        <button type="submit" name="publish" value="add product" class="btn">add product</button>
                        <button type="submit" name="draft" value="save as draft" class="btn">save as draft</button>
                    </div>
                </form>
            </div>
            </div>
