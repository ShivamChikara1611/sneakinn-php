...
<body>
    <div class="main-container">
        ...
        <section class="message-container dashboard">
                ...
                ?>
                        <div class="box">
                            ...
                            <form action="" method="post">
                                ...
                                <button type="submit" name="delete_msg" value="delete message" class="btn" onclick="return confirm( 'delete this message');">delete message</button>
                            </form>
                        </div>
                <?php
                    }
