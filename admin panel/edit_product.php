                        ...
                        <div class="edit-form">
                            <div class="input-field">
                                ...
                                if ($fetch_product['image'] != '') { ?>
                                    ...
                                    <div class="flex-btn">
                                        <button type="submit" name="delete_image" class="btn" value="delete image">delete image</button>
                                        <a href="view_product.php" class="btn">go back</a>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="flex-btn">
                                <button type="submit" name="update" value="update product" class="btn">update product</button>
                                <button type="submit" name="delete_product" value="delete product" class="btn">delete product</button>
                            </div>
                        </div>
                    </form>
                </div>
